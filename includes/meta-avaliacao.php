...
function pab_av_anamnese_cb($post)
{
    ...
    ?>
    <div class="pab-grid">
        <label><strong>Q.P.</strong><input type="text" name="pab_av_qp" value="<?php echo esc_attr(
            $fields["pab_av_qp"],
        ); ?>" /></label>
        <label><strong>H.D.A.</strong><textarea rows="2" name="pab_av_hda"><?php echo esc_textarea(
            $fields["pab_av_hda"],
        ); ?></textarea></label>
        <label><strong>Objetivos</strong><textarea rows="2" name="pab_av_obj"><?php echo esc_textarea(
            $fields["pab_av_obj"],
        ); ?></textarea></label>
    </div>
    <?php
...
function pab_av_habitos_cb($post)
{
    ...
    <div class="pab-grid">
        ...
        <div id="alc_freq" class="pab-conditional" data-show="sim">
            <label><strong>Frequência</strong><input type="text" name="pab_av_alc_freq" value="<?php echo esc_attr(
                $f["alc_f"],
            ); ?>"></label>
        </div>
        ...
        <div id="tab_freq" class="pab-conditional" data-show="sim">
            <label><strong>Frequência</strong><input type="text" name="pab_av_tabag_freq" value="<?php echo esc_attr(
                $f["tab_f"],
            ); ?>"></label>
        </div>
        ...
        <div id="atv_box" class="pab-conditional" data-show="sim">
            <label><strong>Qual(is)</strong><input type="text" name="pab_av_atv_quais" value="<?php echo esc_attr(
                $f["atv_q"],
            ); ?>"></label>
            <label><strong>Frequência</strong><input type="text" name="pab_av_atv_freq" value="<?php echo esc_attr(
                $f["atv_f"],
            ); ?>"></label>
        </div>
        ...
        <label><strong>Tipo de Alimentação</strong>
            <select name="pab_av_alim_tipo">
                <option value="hipo" <?php selected(
                    $f["alim_tipo"],
                    "hipo",
                ); ?>>Hipocalórica</option>
                ...
                <option value="hiper" <?php selected(
                    $f["alim_tipo"],
                    "hiper",
                ); ?>>Hipercalórica</option>
            </select>
        </label>
        <label><strong>Nº de refeições diárias</strong><input type="text" name="pab_av_alim_ref" value="<?php echo esc_attr(
            $f["alim_ref"],
        ); ?>"></label>

        <label><strong>Consumo de líquido diário</strong><input type="text" name="pab_av_liq" value="<?php echo esc_attr(
            $f["liq"],
        ); ?>"></label>

        <label><strong>Qualidade do sono</strong>
            <select name="pab_av_sono_qual">
                <option value="ruim" <?php selected(
                    $f["sono_q"],
                    "ruim",
                ); ?>>Ruim</option>
                <option value="bom" <?php selected(
                    $f["sono_q"],
                    "bom",
                ); ?>>Bom</option>
                <option value="excelente" <?php selected(
                    $f["sono_q"],
                    "excelente",
                ); ?>>Excelente</option>
            </select>
        </label>
        <label><strong>Horário de dormir</strong><input type="time" name="pab_av_sono_hd" value="<?php echo esc_attr(
            $f["sono_hd"],
        ); ?>"></label>
        <label><strong>Horário de acordar</strong><input type="time" name="pab_av_sono_ha" value="<?php echo esc_attr(
            $f["sono_ha"],
        ); ?>"></label>
        <label><strong>Funcionamento intestinal</strong><input type="text" name="pab_av_intest" value="<?php echo esc_attr(
            $f["intest"],
        ); ?>"></label>
    </div>
    <?php
